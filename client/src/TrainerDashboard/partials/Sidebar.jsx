    ...
    <div>
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          {/* Logo */}
          <NavLink  style={{display:"flex",alignItems:"center",gap:"10px"}} end to="/trainer" className="block">
             <div className='flex justify-center items-center'>
                    <div>
                      <img className='rounded-full' width="60" height="32" viewBox="0 0 32 32" src={`http://localhost:4000/uploads/${data.image}`} alt="" />
                    </div>
                    <div>
              ...
              {/* <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('inbox') && 'bg-slate-900'}`}>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Work Progress</span>
                  </div>
                </NavLink>
              </li> */}
